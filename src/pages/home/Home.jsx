  ...
  return (
    <>
      <div className="h-screen">
        <div className="grid place-content-center h-full text-green-700 tracking-widest">
          <span className="text-5xl mx-auto font-bold tracking-[0.25em] shadow-[0_0px_60px_-10px_rgba(0.3,0.3,0.3,0.3)] shadow-green-700 p-3 rounded-lg">
          Hack X</span>
