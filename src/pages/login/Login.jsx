  ...
  return (
    <>
      <div className="flex flex-col justify-center align-middle h-screen">
        ...
        <div className="flex justify-center border-2 rounded-xl border-green-700 font-sans flex-col align-middle w-2/6 mx-auto text-center p-10 m-5 shadow-2xl">
          ...
          <form className="mt-10 text-left flex flex-col text-green-500">
            ...
            <input
              type="submit"
              value="Login"
              className="text-white text-xl bg-green-600 py-2 mt-4 cursor-pointer rounded-lg hover:bg-white hover:text-green-900"
            />
          </form>
          <div className="mt-10 flex justify-between">
            <button className="border-2 px-4 py-1 rounded-xl flex align-middle justify-center gap-2">
              <img
